...
_sym_db.RegisterEnumDescriptor(_BUCKETPROVIDER)

BucketProvider = enum_type_wrapper.EnumTypeWrapper(_BUCKETPROVIDER)
GCS = 0
S3 = 1
AZ = 2
STRICT = 3
...
_WORKSPACEENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='provider', full_name='seekret.api_gateway.WorkspaceEntry.provider', index=7,
...
_WORKSPACEENTRY.fields_by_name['provider'].enum_type = _BUCKETPROVIDER
...
DESCRIPTOR.enum_types_by_name['BucketProvider'] = _BUCKETPROVIDER
